    ...
    public static class DatabaseSeeder
    {
        ...
        )
        {
            ...
            if (!flightRepo.GetAllFlights().Any())
            {
                ...
                {
                    new Flight { FlightNumber = "WY101", DepartureUtc = DateTime.UtcNow.AddHours(2),  ArrivalUtc = DateTime.UtcNow.AddHours(5),  Status = "Scheduled", RouteId = routes[0].RouteId, AircraftId = aircrafts[0].AircraftId },
                    new Flight { FlightNumber = "WY102", DepartureUtc = DateTime.UtcNow.AddHours(4),  ArrivalUtc = DateTime.UtcNow.AddHours(7),  Status = "Scheduled", RouteId = routes[1].RouteId, AircraftId = aircrafts[1].AircraftId },
                    new Flight { FlightNumber = "WY103", DepartureUtc = DateTime.UtcNow.AddHours(6),  ArrivalUtc = DateTime.UtcNow.AddHours(11), Status = "Delayed",   RouteId = routes[2].RouteId, AircraftId = aircrafts[2].AircraftId },
                    new Flight { FlightNumber = "WY104", DepartureUtc = DateTime.UtcNow.AddHours(8),  ArrivalUtc = DateTime.UtcNow.AddHours(13), Status = "Delayed",   RouteId = routes[3].RouteId, AircraftId = aircrafts[3].AircraftId },
                    new Flight { FlightNumber = "WY105", DepartureUtc = DateTime.UtcNow.AddHours(10), ArrivalUtc = DateTime.UtcNow.AddHours(12), Status = "Cancelled", RouteId = routes[4].RouteId, AircraftId = aircrafts[4].AircraftId },
                    new Flight { FlightNumber = "WY106", DepartureUtc = DateTime.UtcNow.AddHours(12), ArrivalUtc = DateTime.UtcNow.AddHours(15), Status = "Scheduled", RouteId = routes[5].RouteId, AircraftId = aircrafts[5].AircraftId },
                    new Flight { FlightNumber = "WY107", DepartureUtc = DateTime.UtcNow.AddHours(14), ArrivalUtc = DateTime.UtcNow.AddHours(16), Status = "Cancelled", RouteId = routes[6].RouteId, AircraftId = aircrafts[6].AircraftId },
                    new Flight { FlightNumber = "WY108", DepartureUtc = DateTime.UtcNow.AddHours(16), ArrivalUtc = DateTime.UtcNow.AddHours(22), Status = "Scheduled", RouteId = routes[7].RouteId, AircraftId = aircrafts[7].AircraftId },
                    new Flight { FlightNumber = "WY109", DepartureUtc = DateTime.UtcNow.AddHours(18), ArrivalUtc = DateTime.UtcNow.AddHours(20), Status = "Delayed",   RouteId = routes[8].RouteId, AircraftId = aircrafts[8].AircraftId },
                    new Flight { FlightNumber = "WY110", DepartureUtc = DateTime.UtcNow.AddHours(20), ArrivalUtc = DateTime.UtcNow.AddHours(23), Status = "Cancelled", RouteId = routes[9].RouteId, AircraftId = aircrafts[9].AircraftId }
                };
